...
val blue1 = Color(0xFFADD8E6) // Light Blue
val blue2 = Color(0xFF87CEEB) // Sky Blue
val blue3 = Color(0xFF4682B4) // Steel Blue
val blue4 = Color(0xFF1E90FF) // Dodger Blue
val blue5 = Color(0xFF0000CD) // Medium Blue
val blue6 = Color(0xFF00008B) // Dark Blue

val pink1 = Color(0xFFFFC1CC) // Light Pink
val pink2 = Color(0xFFFFB6C1) // Pale Pink
val pink3 = Color(0xFFFF69B4) // Hot Pink
val pink4 = Color(0xFFDB7093) // Medium Pink
val pink5 = Color(0xFFC71585) // Deep Pink
val pink6 = Color(0xFFB03060) // Dark Pink